    ...
    <SliderContainer className={isBuildingHTML ? "server-rendered" : null}>
      <Slider {...settings}>
        <HeroSection className={"hero-Stacked"}>
          <StaticImage
            src="../assets/process/process-banner.jpg"
...
The Process
                ...
                <HeroDescription>
                  <p className="pb-5">
                 Our track record speaks for itself: consistent delivery of quality and craftsmanship in both plantscapes and hardscapes.
                  </p>
