...
const { status } = this.state;
    ...
    return (
     ...
     <form
        ...
        action="https://formspree.io/mqkyjlep"
        method="POST"
...
<div className="form-group">
    ...
    <div className="form-group">
      ...
      <input type="file" name="attachment" accept="image/png, image/jpeg" onChange={this.handleChange} className="form-control" id="attachment" />
        ...
        <PrivacyStatement><Lock size={13}/>
        <p>Your privacy is important to us. Data sumbmitted is encrypted and never shared with anyone.</p>
