    ...
    <SliderContainer className={isBuildingHTML ? "server-rendered" : null}>
      <Slider {...settings}>
        <HeroSection className={"hero-Stacked"}>
          <StaticImage
            src="../assets/trees/tree-banner.jpg"
...
Large Trees & Evergreen Installations
  </HeroHeading>
                <HeroDescription>
                  <p className="pb-5">With over 25 years of experience in transplanting trees and shrubs, you can count on us to transplant your trees and shrubs without compromising their root systems.
                  </p>
