    ...
    <SliderContainer className={isBuildingHTML ? "server-rendered" : null}>
      <Slider {...settings}>
        <HeroSection className={"hero-Stacked"}>
          <StaticImage
            src="../assets/maintenance/maintenance-banner.jpg"
...
Horticulture Maintenance
                ...
                <HeroDescription>
                  <p className="pb-5">Our horticulture management is rooted in over 25 years of experience. Specializing in the transplantation of trees and shrubs, we bring an unmatched level of expertise and care to every project.
                  </p>
