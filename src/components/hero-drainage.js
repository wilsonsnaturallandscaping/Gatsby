    ...
    <SliderContainer className={isBuildingHTML ? "server-rendered" : null}>
      <Slider {...settings}>
        <HeroSection className={"hero-Stacked"}>
          <StaticImage
            src="../assets/drainage/drainage-banner.jpg"
...
Drainage Solutions
                ...
                <HeroDescription>
                  <p className="pb-5">At Wilson's Natural Landscaping, we specialize in transforming challenging drainage problems into beautiful, functional landscapes.
                  </p>
