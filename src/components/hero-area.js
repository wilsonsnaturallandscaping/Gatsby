    ...
    <SliderContainer className={isBuildingHTML ? "server-rendered" : null}>
      <Slider {...settings}>
        <HeroSection className={"hero-Stacked"}>
          <StaticImage
            src="../assets/home/home-banner-one.jpg"
            alt="Wilsons Home Banner Image"
          ...
          <ContentContainer className="container">
            <ContentRow className="row">
              <ContentCol className="col-md-9 col-lg-6">
                ...
                <HeroDescription>
                  <p className="pb-5">
                    We take the time to educate and work with our clients to create a beautiful landscape that is
                    functional, resilient, and eco-friendly.
                  </p>
